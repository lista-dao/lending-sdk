...
import { LENDING_BROKER_ABI, type NetworkName } from '@lista-dao/moolah-sdk-core';
import type { ChainId, StepParam } from '../types';
import { buildCallParams } from '../utils';
import { buildApproveSteps } from './approve';

export function buildBrokerBorrowSteps(
    params: {
        chainId: ChainId;
    ...
    return [
        {
            ...
            params: buildCallParams({
                ...
                functionName: 'borrow',
                args: params.termId !== undefined ? [params.amount, params.termId] : [params.amount],
        ...
        params: buildCallParams({
            ...
            args:
                params.posId !== undefined
                    ? [params.amount, params.posId, params.onBehalf ?? params.walletAddress]
