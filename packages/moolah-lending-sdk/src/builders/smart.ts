...
export async function buildSmartSupplyDexLpSteps(
    ...
    steps.push({
        ...
        params: buildCallParams({
            ...
            args: [buildSmartMarketParams(smartConfig), params.onBehalf ?? params.walletAddress, params.lpAmount],
            chainId: params.chainId,
        }),
    });
    ...
    if (smartConfig.loanIsNative) {
        steps.push({
            ...
            params: buildCallParams({
                ...
                functionName: 'repay',
                args: [buildSmartMarketParams(smartConfig), assets, shares, params.onBehalf ?? params.walletAddress, '0x'],
                value: nativeValue,
                chainId: params.chainId,
            }),
        });
