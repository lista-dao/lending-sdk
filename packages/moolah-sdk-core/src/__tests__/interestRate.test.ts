...
describe('getBorrowRateInfo', () => {
    ...
    it('should apply rate cap', () => {
        ...
        expect(result.latestBorrowRate).toBeLessThanOrEqual(uncappedResult.latestBorrowRate);
    });
    ...
    it('should apply rate floor', () => {
        ...
        expect(result.latestBorrowRate).toBeGreaterThanOrEqual(unfloored.latestBorrowRate);
    });
});
...
describe('getInterestRates', () => {
    ...
    it('should apply rate cap', () => {
        ...
        expect(highUtil.borrowRate).toBeLessThanOrEqual(highUtilUncapped.borrowRate);
    });
    ...
    it('should apply rate floor', () => {
        ...
        expect(lowUtil.borrowRate).toBeGreaterThanOrEqual(lowUtilUnfloored.borrowRate);
    });
});
...
describe('getFixedRateInterestRates', () => {
    ...
    it('should have increasing supply rate with utilization', () => {
        ...
        for (let i = 1; i < rates.length; i++) {
            expect(rates[i].supplyRate).toBeGreaterThanOrEqual(rates[i - 1].supplyRate);
        }
    });
