...
export class Decimal extends Fraction {
    ...
    private static getDecimal(arg1: Fraction | Decimal | BigintIsh, arg2?: number): Decimal {
    ...
    add(other: Fraction | Decimal | BigintIsh, decimal?: number | BigintIsh): Decimal {
        const otherDecimal = Decimal.getDecimal(other, typeof decimal === 'number' ? decimal : undefined)
    ...
    sub(other: Fraction | Decimal | BigintIsh, decimal?: number | BigintIsh): Decimal {
        const otherDecimal = Decimal.getDecimal(other, typeof decimal === 'number' ? decimal : undefined)
    ...
    mul(other: Fraction | Decimal | BigintIsh, decimal?: number | BigintIsh): Decimal {
        const otherDecimal = Decimal.getDecimal(other, typeof decimal === 'number' ? decimal : undefined)
    ...
    div(other: Fraction | Decimal | BigintIsh, decimal?: number | BigintIsh): Decimal {
        const otherDecimal = Decimal.getDecimal(other, typeof decimal === 'number' ? decimal : undefined)
